...
export default function UserSideBarMenu() {
	...
	return (
		<div className='UserSideBarMenu'>
			...
			<div className={true ? 'SideBarMenuOpen' : 'SideBarMenuClosed'}>
				<div className='SideBarMenuContent'>
					<div className='closeSideBarCross' onClick={userCloseSideMenu}>
						<FaRegWindowClose />
					</div>
						...
						{userMenuItemsList.map((item) => {
							...
							return (
								<div key={menu_item_id}>
									<span className='NavLinkMenuItemStyling' onClick={userCloseSideMenu}>
